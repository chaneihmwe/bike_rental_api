...
<head>
  ...
  <!-- Jquery DataTable -->
  <link rel="stylesheet" type="text/css" href="{{asset('table/css/dataTables.css')}}">
  <link href="{{asset('table/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">
  <link href="{{asset('table/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.bike.index')}}">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Bike</span></a>
      </li>
  ...
  <script src="{{asset('backend_template/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{asset('backend_template/js/sb-admin-2.min.js')}}"></script>

  <!-- JQuery DataTable -->
  <script src="{{asset('table/datatables/jquery.dataTables.js')}}"></script>
  <script src="{{asset('table/datatables/dataTables.bootstrap4.js')}}"></script>
  <script src="{{asset('table/js/demo/datatables-demo.js')}}"></script>
